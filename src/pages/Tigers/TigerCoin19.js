...
export default function TigerCoin19(){

    return(
        <div>
            <CoinTemplate
                coin={'https://i.imgur.com/ez2o2zz.gif'}
                title={'Burnt Orange Sunshine Tiger'}
                ...
                nextLink={'/GleamingGoldTiger'}
                prevLink={'/RoseGoldTiger'}
            />
       </div>
    )
}