...
export default function RhinoCoin6(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/RhinoCoins/rhinofinal6.gif'}
                title={'Orange Crush Rhino'}
                ...
                nextLink={'/GreatGoldenRhino'}
                prevLink={'/RagingRedRhino'}
            />
       </div>
    )
}