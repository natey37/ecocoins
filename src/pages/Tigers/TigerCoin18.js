...
export default function TigerCoin18(){

    return(
        <div>
            <CoinTemplate
                coin={'https://i.imgur.com/MTt3PIy.gif'}
                title={'Rose Gold Tiger'}
                ...
                nextLink={'/BurntOrangeSunshineTiger'}
                prevLink={'/MysticalYellowTiger'}
            />
       </div>
    )
}