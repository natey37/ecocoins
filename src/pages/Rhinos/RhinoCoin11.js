...
export default function RhinoCoin11(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/RhinoCoins/rhinofinal11.gif'}
                title={'Purple Passion Rhino'}
                ...
                nextLink={'/MarvelousMagesticMagentaRhino'}
                prevLink={'/BoldBlueRhino'}
            />
       </div>
    )
}