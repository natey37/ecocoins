...
export default function RhinoCoin9(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/RhinoCoins/rhinofinal9.gif'}
                title={'Simmering Swimming Rhino'}
                ...
                nextLink={'/BoldBlueRhino'}
                prevLink={'/ParadisePunchRhino'}
            />
       </div>
    )
}