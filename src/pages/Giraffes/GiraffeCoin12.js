...
export default function GiraffeCoin12(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/GiraffeCoin/giraffefinal12.gif'}
                title={'Hootin Halloween Giraffe'}
                ...
                nextLink={'/GreenGatsbyGiraffe'}
                prevLink={'/RazzyRaspberryGiraffe'}
            />
       </div>
    )
}