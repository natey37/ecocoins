...
export default function TigerCoin14(){

    return(
        <div>
            <CoinTemplate
                coin={'https://i.imgur.com/boiMCOU.gif'}
                title={'Blundering Brown Tiger'}
                ...
                nextLink={'/StrawberryDreamsTiger'}
                prevLink={'/PinkPassionTiger'}
            />
       </div>
    )
}