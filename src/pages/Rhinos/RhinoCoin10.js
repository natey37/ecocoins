...
export default function RhinoCoin10(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/RhinoCoins/rhinofinal10.gif'}
                title={'Bold Blue Rhino'}
                ...
                nextLink={'/PurplePassionRhino'}
                prevLink={'/SimmeringSwimmingRhino'}
            />
       </div>
    )
}