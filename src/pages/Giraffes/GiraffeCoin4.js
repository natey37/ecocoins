...
export default function GiraffeCoin4(){
    ...
    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/GiraffeCoin/giraffefinal4.gif'}
                title={'Jungle Jam Giraffe'}
                ...
                nextLink={'/NeonNitroGiraffe'}
                prevLink={'/CottonCandyDreamsGiraffe'}
            />
       </div>
    )
}