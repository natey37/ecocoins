...
export default function GiraffeCoin4(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/GiraffeCoin/giraffefinal7.gif'}
                title={'Easy Breezy Giraffe'}
                ...
                nextLink={'/MidnightMadnessGiraffe'}
                prevLink={'/JungleBoogeyGiraffe'}
            />
       </div>
    )
}