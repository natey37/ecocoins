...
export default function GiraffeCoin1(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/GiraffeCoin/giraffefinal1.gif'}
                title={'Green Gatsby Giraffe'}
                ...
                nextLink={'/EternalSummerGiraffe'}
                prevLink={'/HootinHalloweenGiraffe'}
            />
       </div>
    )
}