...
export default function GiraffeCoin9(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/GiraffeCoin/giraffefinal9.gif'}
                title={'Whispering White Giraffe'}
                ...
                nextLink={'/SummerBluesGiraffe'}
                prevLink={'/MidnightMadnessGiraffe'}
            />
       </div>
    )
}