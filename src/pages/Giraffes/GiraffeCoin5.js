...
export default function GiraffeCoin5(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/GiraffeCoin/giraffefinal5.gif'}
                title={'Neon Nitro Giraffe'}
                ...
                nextLink={'/JungleBoogeyGiraffe'}
                prevLink={'/JungleJamGiraffe'}
            />
       </div>
    )
}