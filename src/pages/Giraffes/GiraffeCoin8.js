...
export default function GiraffeCoin8(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/GiraffeCoin/giraffefinal8.gif'}
                title={'Midnight Madness Giraffe'}
                ...
                nextLink={'/WhisperingWhiteGiraffe'}
                prevLink={'/EasyBreezyGiraffe'}
            />
       </div>
    )
}