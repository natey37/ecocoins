...
export default function GiraffeCoin3(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/GiraffeCoin/giraffefinal3.gif'}
                title={'Cotton Candy Dreams Giraffe'}
                ...
                nextLink={'/JungleJamGiraffe'}
                prevLink={'/EternalSummerGiraffe'}
            />
       </div>
    )
}