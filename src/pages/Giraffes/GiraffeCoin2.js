...
export default function GiraffeCoin2(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/GiraffeCoin/giraffefinal2.gif'}
                title={'Eternal Summer Giraffe'}
                ...
                nextLink={'/CottonCandyDreamsGiraffe'}
                prevLink={'/GreenGatsbyGiraffe'}
            />
       </div>
    )
}