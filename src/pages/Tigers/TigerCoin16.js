...
export default function TigerCoin16(){

    return(
        <div>
            <CoinTemplate
                coin={'https://i.imgur.com/t0K7J9M.gif'}
                title={'Apocalyptic Gold Tiger'}
                ...
                nextLink={'/MysticalYellowTiger'}
                prevLink={'/StrawberryDreamsTiger'}
            />
       </div>
    )
}