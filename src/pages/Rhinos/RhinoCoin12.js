...
export default function RhinoCoin12(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/RhinoCoins/rhinofinal12.gif'}
                title={'Marvelous Magestic Magenta Rhino'}
                ...
                nextLink={'/NeonGothicRhino'}
                prevLink={'/PurplePassionRhino'}
            />
       </div>
    )
}