...
export default function GiraffeCoin10(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/GiraffeCoin/giraffefinal10.gif'}
                title={'Summer Blues Giraffe'}
                ...
                nextLink={'/RazzyRaspberryGiraffe'}
                prevLink={'/WhisperingWhiteGiraffe'}
            />
       </div>
    )
}