...
export default function RhinoCoin5(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/RhinoCoins/rhinofinal5.gif'}
                title={'Raging Red Rhino'}
                ...
                nextLink={'/OrangeCrushRhino'}
                prevLink={'/StompingStormRhino'}
            />
       </div>
    )
}