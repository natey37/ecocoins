...
export default function RhinoCoin2(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/RhinoCoins/rhinofinal2.gif'}
                title={'Yellow Thunder Rhino'}
                ...
                nextLink={'/GrassyNGassyGreenRhino'}
                prevLink={'/NeonGothicRhino'}
            />
       </div>
    )
}