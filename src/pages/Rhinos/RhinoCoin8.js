...
export default function RhinoCoin8(){

    return(
        <div>
            <CoinTemplate
                coin={'https://eco-coins.s3-us-west-2.amazonaws.com/RhinoCoins/rhinofinal8.gif'}
                title={'Paradise Punch Rhino'}
                ...
                nextLink={'/SimmeringSwimmingRhino'}
                prevLink={'/GreatGoldenRhino'}
            />
       </div>
    )
}